...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaUpdater.Database.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("MangaUpdater.Entities.UserChapter", b =>
                {
                    b.HasOne("MangaUpdater.Entities.Chapter", "Chapter")
                        .WithOne("UserChapter")
                        .HasForeignKey("MangaUpdater.Entities.UserChapter", "ChapterId");
                    ...
                    b.HasOne("MangaUpdater.Entities.UserManga", "UserManga")
                        .WithOne("UserChapter")
                        .HasForeignKey("MangaUpdater.Entities.UserChapter", "UserMangaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MangaUpdater.Database.Identity.AppUser", null)
                        .WithMany()
